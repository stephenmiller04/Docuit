//Markdown to HTML By Leanote
//https://github.com/leanote/markdown-to-html
...
(function() {
	...
	function initUml() {
	    ...
	    umlDiagrams.convert = function(target, callback) {
	        ...
	        var sequenceElems = previewContentsElt.querySelectorAll('.code > .language-sequence');
	        var flowElems = previewContentsElt.querySelectorAll('.code > .language-flow');
